...
export class AppComponent implements OnInit {
  ...
  constructor() {
      ...
      this.post_stromae = new Post('Stromae', 'Tout simplement Formidable :) ', 100000, new Date('1960-01-17T03:24:00'));
      this.post_ironMaiden = new Post('Iron Maiden', 'Listen The trooper, Fear of the Dark ... ', 100000, new Date('1960-01-17T03:24:00'));
